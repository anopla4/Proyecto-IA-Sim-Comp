...
main(
    ...
    RandVarEffect dipirona_doble_action = { 0.82 -> effect p_dolorCabeza p -6.8, p_fiebre p -1.5; 0.18 -> effect p_fiebre p 0 }\n
    RandVarEffect calbamol_action = { 0.4 -> effect p_dolorCabeza p -2, p_fiebre p -0.5, plaqueta p 3; 0.4 -> effect p_dolorCabeza p -3, p_fiebre p -0.5; 0.2 -> effect p_fiebre p 0 }\n
    RandVarEffect jarabe_action = { 0.75 -> effect tos p -6; 0.25 -> effect tos p 0 }\n
    RandVarEffect antibiotico_action = { 0.5 -> effect p_fiebre p -1.6, effect tos p -10, effect plaqueta p 2.4; 0.3 -> effect p_fiebre p -1.4, effect tos p -6; 0.2 -> effect p_fiebre p -1, effect plaqueta p 6}\n
