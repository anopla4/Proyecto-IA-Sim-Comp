...
main(
    ...
    RandVarEffect dipirona_simple_action = { 0.7 -> effect p_dolorCabeza p -4.4, effect p_fiebre p -1; 0.3 -> effect p_fiebre p 0 };\n
    RandVarEffect dipirona_doble_action = { 0.82 -> effect p_dolorCabeza p -6.8, effect p_fiebre p -1.5; 0.18 -> effect p_fiebre p 0 };\n
    RandVarEffect calbamol_action = { 0.4 -> effect p_dolorCabeza p -2, effect p_fiebre p -0.5, effect p_plaqueta p 3; 0.4 -> effect p_dolorCabeza p -3, effect p_fiebre p -0.5; 0.2 -> effect p_fiebre p 0 };\n
    RandVarEffect jarabe_action = { 0.75 -> effect p_tos p -6; 0.25 -> effect p_tos p 0 };\n
    RandVarEffect antibiotico_action = { 0.5 -> effect p_fiebre p -1.6, effect p_tos p -10, effect p_plaqueta p 2.4; 0.3 -> effect p_fiebre p -1.4, effect p_tos p -6; 0.2 -> effect p_fiebre p -1, effect p_plaqueta p 6};\n
    RandVarEffect plaquetol_action = { 0.5 -> effect p_plaqueta p 2; 0.3 -> effect p_plaqueta p 5; 0.2 -> effect p_plaqueta p 0 };\n
    ...
    main(p,[antibiotico, jarabe, dipirona_simple, dipirona_doble, calbamol, plaquetol], [tos, fiebre, dolor_cabeza], 1, 168, 5000)"""
)
