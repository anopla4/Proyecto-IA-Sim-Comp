...
class Or(BinaryExpression):
    ...
    def build_automaton(self, left_automaton, right_automaton):
        ...
        states = [init_state, final_state] + \
            left_automaton.states + right_automaton.states
        characters = ["epsilon"] + left_automaton.characters + \
            right_automaton.characters
        characters = list(set(characters))
        transition_function = dict(list(left_automaton.transition_function.items(
        ...
        transition_function[(init_state, "epsilon")] = [
            initial_state_left, initial_state_right]
